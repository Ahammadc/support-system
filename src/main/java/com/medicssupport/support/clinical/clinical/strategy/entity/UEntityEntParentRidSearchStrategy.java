...
@Component(UEntityConstants.STRATEGY_ENT_PARENT_RID)
@Slf4j
public class UEntityEntParentRidSearchStrategy extends SearchStrategyExtended<UEntity> {
    ...
    public Page<UEntity> search(List<SearchData> searchData, Pageable pageable) {
        ...
        log.info("Searching entity by ent_parent_rid: {}", entParentRids);

        return uEntityRepository.findAllByEntParentRidIn(entParentRids, pageable);
    }
